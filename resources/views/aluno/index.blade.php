@extends('layouts.ava')
@section('titulo', 'AVA | Cadastro Aluno')
@section('conteudo')
       ...
       @include('layouts.menus.aside')
        ...
        @include('layouts.breadcrumb')
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-2">
                        <button type="button" id="add-aluno" class="btn btn-rounded btn-block btn-info"> Adicionar Aluno</button>
</div>
                        <div class="col-lg-12 mt-4">
                    <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Meus Alunos </h4>
                    ...
                    <div class="col-lg-4" style="z-index:1000; position:absolute; top:0px; right:0px; padding-right:0px;" id="cadastro-aluno">
